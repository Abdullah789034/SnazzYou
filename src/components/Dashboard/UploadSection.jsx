...
const UploadSection = () => {
    return (
        <div className="flex flex-col md:flex-row mt-8 p-6 bg-gradient-to-r from-gray-700 to-gray-900 rounded-lg shadow-lg">
            <div className="flex flex-col md:flex-row w-full md:w-3/4 p-6 bg-black rounded-lg shadow-lg">
                ...
                <div className="w-full md:w-1/3 flex flex-col justify-center items-center md:items-end gap-4 mt-4 md:mt-0">
                    <div className="flex flex-col items-center md:items-end">
                        <p className="text-xl text-gray-300 mt-2">Based on previous analysis</p>
