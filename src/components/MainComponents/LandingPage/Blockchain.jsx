        ...
        <div className=" flex flex-col items-center w-full mt-10 p-4 md:p-8">
          <div className="relative flex flex-wrap justify-center w-full gap-8 max-w-screen-lg">
            ...
            <div className="relative flex flex-col items-center w-full max-w-xs p-4 space-y-4 text-center bg-gradient-to-b from-[#12100B] to-[#16171E] md:w-1/3 h-[320px]">
              ...
              <p className="text-sm md:text-base text-white">
                No more bankers ripping out huge spreads because of a lack of
                transparency
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center w-full max-w-xs p-4 space-y-4 text-center bg-gradient-to-b from-[#12100B] to-[#16171E] md:w-1/3 h-[320px]">
              ...
              <p className="text-sm md:text-base text-white">
                No more banks keeping their customers in the dark when it comes
                to dangerous risk exposure
              </p>
            </div>
            <div className="hidden md:block absolute h-[10px] w-[80%] bottom-8">
              <div className="h-[2px] bg-gray-400 w-full"></div>
              <div className="relative w-full">
                <div className="absolute flex items-center justify-between w-full -top-2">
                  <div className="bg-[#fff050] h-[15px] rounded-full w-[15px]"></div>
                  <div className="bg-[#fff050] h-[15px] rounded-full w-[15px]"></div>
                  <div className="bg-[#fff050] h-[15px] rounded-full w-[15px]"></div>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center w-full mt-8 p-4 md:p-8 space-y-4 max-w-screen-lg">
            <h2 className="text-lg lg:text-3xl lg:w-2/3 font-['Montserrat'] font-bold text-center text-white">
              Get ready for a revolution.{" "}
              <span className="text-[#fff04f]">DeFi and the Blockchain</span>{" "}
              are about to shake up the way we think about and interact with our
              money.
            </h2>
            <p className="text-md lg:text-lg text-center text-white">
              With our expertise and resources, we'll empower you to navigate
              the complexities of this new era of finance, turning understanding
              into action and potential into profit.
            </p>
          </div>
        </div>
      </div>
