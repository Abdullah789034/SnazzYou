...
const Blockchain = () => {
    return (
        <div style={{ backgroundColor: 'black' }}>
            <div
                className="w-full h-[620px] flex items-center justify-center"
                style={{ backgroundImage: `url(${bgImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
            >
                <div className="flex flex-col items-center w-full mt-10 p-8">
                    <div className="flex flex-wrap justify-center w-full gap-8">
                        ...
                        <div className="relative flex flex-col items-center w-full max-w-xs p-4 space-y-4 text-center bg-gradient-to-b from-[#12100B] to-[#16171E] md:w-1/3">
                            ...
                            />
                            <h3 className="text-xl font-bold text-white">No Middlemen</h3>
                            <p className="text-white">No more shady middlemen</p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center w-full max-w-xs p-4 space-y-4 text-center bg-gradient-to-b from-[#12100B] to-[#16171E] md:w-1/3">
                            <img
                                ...
                                className="w-24 h-auto -mt-14"
                            />
                            <h3 className="text-xl font-bold text-white">No Bankers</h3>
                        ...
                        <div className="relative flex flex-col items-center w-full max-w-xs p-4 space-y-4 text-center bg-gradient-to-b from-[#12100B] to-[#16171E] md:w-1/3">
                            <img
                                ...
                                className="w-24 h-auto -mt-14"
                            />
                            <h3 className="text-xl font-bold text-white">No Banks</h3>
                            <p className="text-white">
                    ...
                    {/* Revolution Section */}
                    <div className="flex flex-col items-center w-2/4 p-8 mt-8 space-y-4 ">
