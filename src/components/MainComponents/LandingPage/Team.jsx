...
const teamMembers = [
  ...
  {
    name: "Charls",
    role: "CYBERSECURITY SENIOR SPECIALIST",
    imgSrc: CharlsImg,
  },
  {
    name: "Christopher",
    role: "CORPORATE FINANCE ADVISOR",
    imgSrc: ChristopherImg,
  },
...
const Team = () => {
  return (
    <section className="our_team_sec text-center py-8">
      <h2 className="text-3xl text-gray-900 font-semibold mb-4 font-[Oswald]">
        MEET OUR TEAM
      </h2>
      <p className="mb-8">
        We pride ourselves on attracting the best and brightest in the business.{" "}
        <br />
