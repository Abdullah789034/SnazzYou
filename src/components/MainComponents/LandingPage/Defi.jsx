    ...
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center text-center space-y-4">
                <img src={img} alt="" className="w-[50%] sm:w-[20%] md:w-[50%] h-auto" />
                <div className="w-full max-w-[800px] text-white space-y-4 text-lg px-4 md:px-0">
                    <p>
                        Welcome to the future of finance
                        <strong className="text-yellow-300"> Decentralized Finance, or DeFi</strong>.
                    ...
                    <p>
                        ...
                        </strong> that guarantee transparency in every transaction,
                    ...
                    <p>
                        ...
                        <strong className="text-yellow-300"> That's the promise of DeFi</strong>.
                    </p>
                    <p>
