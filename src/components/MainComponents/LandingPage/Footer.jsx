...
const Footer = () => {
    return (
        <div className="bg-[#15212B] p-10 pt-10 pb-5">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center text-white mt-20 space-y-4 md:space-y-0 md:space-x-4 text-xs">
                <a href="#" className="border-r border-white pr-4">Scam warning</a>
                <a
                ...
                <a href="#" className="border-r border-white pr-4">Disclosures</a>
                <a
