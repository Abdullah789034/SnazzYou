...
const WallStreet = ({ onButtonClick }) => {
    return (
        <div>
            ...
            >
                <div className='w-full lg:w-[65%] p-4 md:p-8'>
                    <span className='text-[#FFF04F] text-3xl md:text-4xl font-[800] font-[Montserrat]'>SO WHAT ARE YOU GOING TO DO?</span>
                </div>
                <div className='flex flex-col md:flex-row gap-4 font-[Montserrat] w-full md:w-[90%] lg:w-[55%]'>
                    <div className='w-full md:w-1/2 text-white text-lg md:text-xl font-[600] space-y-4'>
                        <div>One of my favourite movie scenes comes from WALL STREET when Bud Fox says</div>
                        <div className='text-3xl font-[700]'>
                            <span className="text-[#FFF04F]">“</span>
                ...
                <div className="text-white w-full  lg:w-[60%] text-lg md:text-xl font-[400] mt-10 space-y-4">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8">
                    <img
                        ...
                        src={joinNow}
                        alt="Join Now"
                        className="w-[50%] md:w-[30%] h-auto mb-4 md:mb-0"
                    />
                    <button
                        onClick={onButtonClick}
                        className="inline-block bg-blue-600 text-white rounded-full py-3 px-16 text-lg md:text-xl font-extrabold uppercase"
                    >
                        Book a Call
                    </button>
                </div>
