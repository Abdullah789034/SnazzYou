  ...
  return (
    <div >
      ...
      <div style={{ backgroundColor: '#fff04f' }}
        className="relative h-[113px] w-full flex items-center justify-center"
      >
        <span className="font-bold text-2xl text-center font-sans-serif" style={{ fontFamily: "Montserrat" }}>JOIN CAPITALS CLUB TODAY AND EMBARK ON A JOURNEY  TOWARDS FINANCIAL FREEDOM AND PROSPERITY</span>
      </div>
      <BookCall />
      <CryptoHit />
      <WorkDetails />
